...
class EntityRecognitionRequest(BaseModel):
    text: str = Field(
        ..., example="London is a big city in the United Kingdom."
    )
...
class RecommendationBase(BaseModel):
    ...
    content: str = Field(
        ..., example="It is recommended to regularly update your passwords..."
    )
...
class TrainingBase(BaseModel):
    ...
    content: str = Field(
        ...,
        example="Docker is a set of platform as a service products that use OS-level virtualization...",
    )
...
class FeedbackBase(BaseModel):
    content: str = Field(
        ..., example="This new feature has significantly improved my workflow!"
    )
