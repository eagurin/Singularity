С удовольствием объединю и дополню `README.md`, расширяя раздел с примером кода для более детального описания использования системы Singularity. Вот полностью сформированный файл `README.md`:
